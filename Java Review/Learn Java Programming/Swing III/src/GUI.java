...
public class GUI extends JFrame {
	...
	public GUI() {
		...
		this.setSize(500,400); //Changes the window size, so components reset and are visible
	}
	...
	private void setUpFrame() {
		...
		this.setSize(500,399); //Sets the size of the window, width, height (alternatives like setBounds exist as well)
